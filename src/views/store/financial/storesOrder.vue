  ...
  <div class="contain">
    ...
    <div class="container">
      <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column property="date" label="订单编号" width="120">
        </el-table-column>
        <el-table-column property="name" label="数量" width="120">
        </el-table-column>
        <el-table-column property="address" label="总金额/元">
        </el-table-column>
        <el-table-column property="address" label="收货信息"> </el-table-column>
