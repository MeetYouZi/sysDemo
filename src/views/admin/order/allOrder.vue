<template>
  <div class="contain">
    ...
    <div class="container">
      <div class="stateBar">
        <div class="stateItem" :class="stateItem == index ? 'active':''" v-for="(item,index) in orderStateList" :key="index" @click="orderStateClick(index)">
          {{item.name}} ({{item.num}})
        </div>
      </div>
      <el-table :data="tableData" stripe style="width: 100%">
        <el-table-column prop="date" label="订单信息" width="180">
        </el-table-column>
        ...
        <el-table-column prop="address" label="分店名"> </el-table-column>
        <el-table-column prop="address" label="是否有未发货商品"> </el-table-column>
